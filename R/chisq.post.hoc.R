#'Tests for significant differences among all pairs of populations in 
...
#'@keywords htest
#'@note This code was adapted and modified from the NCStats package and taken from feifer package: 
#'@examples
